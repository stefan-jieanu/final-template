...
# O clasa generala care indica relatia dintre un user si o postare
# in cazul acesta reprezinta postarile favorite ale unui utilizator
# Poate fi adaptat sa reprezinte o rezeravare, o camanda etc
